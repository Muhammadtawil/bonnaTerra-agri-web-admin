...
import { TestimonialInterface } from '../../services/interfaces';
import { TestimonialsServices } from '../../services/testimonialsServices';
import { deleteAlert, ErrorAlert } from '../common/alerts/alerts';


@Component({
    selector: 'admin-tistimonials',
    standalone: true,
...
testimonials:TestimonialInterface[]=[]
    teamMemberCard = [
        {
            memberImg: `../../../assets/../../../assets/images/users/user1.jpg`,
    ...
    constructor(
     ...
     private   testimonialservice:TestimonialsServices,
    ) {
    ...
    getTestimonials() {
        return this.testimonialservice.getAllTestiminials().subscribe({
            next: (data) => {
    ...
    async onDelete(id: string) {
        const deleteMethod = () => this.testimonialservice.deleteTestiminial(id).toPromise();
    ...
    handleImageError(event: Event) {
        ...
        imgElement.src = 'assets/path/to/default-image.png'; // Path to your default image
    }
